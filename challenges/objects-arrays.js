...
console.log(dino_1.weight);

// What was the diet of a velociraptor?
console.log(dino_3.diet);

// How long was a stegosaurus?
console.log(dino_2.length);

// What time period did tyrannosaurus live in?
console.log(dino_1.period);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
dino_1.roar = function() {
  return `RAWERSRARARWERSARARARRRR!`;
};
console.log(dino_1.roar());
...
zooAnimals.forEach(cv => {
  displayNames.push(cv.animal_name, cv.scientific_name);
});
...
zooAnimals.map(cv => {
  lowCaseAnimalNames.push(cv.animal_name.toLowerCase());
});

...
## Map is non-destructive and will create a new array with the given data, while forEach will alter the array as a whole
...
## When using a class super allows you to target where the extend information needs to go. (Connects object and its methods to another object)
